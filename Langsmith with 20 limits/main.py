...
async def Convo_chain(request: QueryRequest):
    ...
    try:
        # ✅ Get last 30 conversation history for this chatbot
        ...
        try:
            ...
            return JSONResponse(content={"error": f"LangSmith dataset error: {str(e)}"}, status_code=500)

        # ✅ Greeting classifier chain
        ...
        # ✅ Get normal answer from history-aware chain
